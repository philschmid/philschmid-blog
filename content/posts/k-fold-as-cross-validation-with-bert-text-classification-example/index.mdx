...
excerpt: K-Fold Cross-Validation is a resampling procedure used to validate machine learning models on a limited data set. BERT Text-Classification example is included
tag:
  - Machine Learning
  - Python
...
The Example is a implementation for a `BERT Text-Classification` built with [`simpletransformers` library](https://github.com/ThilinaRajapakse/simpletransformers) and `Scikit-Learn`.
