...
The example is an implementation for a `BERT Text-Classification` with [`simpletransformers` library](https://github.com/ThilinaRajapakse/simpletransformers) and `Scikit-Learn`.
