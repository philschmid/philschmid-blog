...
As this guide is not about building a  model, we will use a pre-built version, that I created using `distiller`. You can check the colab notebook [here](https://colab.research.google.com/drive/1eyVi8tkCr7N-sE-yyhDB_lduowp1EZ78?usp=sharing). 
